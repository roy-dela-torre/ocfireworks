...
<?php else : ?>
	<h4 style="margin-bottom: 15px;">Credit Card</h4>
	<?php wc_print_notice( esc_html__( 'No current credit card.', 'woocommerce' ), 'notice' ); ?>
	<a class="button red_button w-100 justify-content-center mt-3" href="<?php echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></a>
<?php endif; ?>
