...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<div class="personal_details">
		<div class="row">
			...
			<div class="col-md-12">
				<a href="<?php echo get_home_url(); ?>/my-account/edit-address/billing/" target="_blank" rel="noopener noreferrer" class="w-100 text-center edit_button red_button text-uppercase d-block" id="edit_details">edit details</a>
			</div>
		</div>
	</div>
	<!-- <div class="clear"></div> -->
