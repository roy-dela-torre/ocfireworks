...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
    ...
    <div class="personal_details">
        <div class="row">
            ...
            <div class="col-md-12">
                <a href="<?php echo esc_url( get_home_url() . '/my-account/edit-address/billing/' ); ?>" target="_blank" rel="noopener noreferrer" class="w-100 text-center edit_button red_button text-uppercase d-block" id="edit_details">Edit Details</a>
            </div>
        </div>
    </div>
    ...
    <p>
        ...
        <button type="submit" class="woocommerce-Button red_button save_changes button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'woocommerce' ); ?></button>
