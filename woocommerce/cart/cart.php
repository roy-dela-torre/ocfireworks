...
<div class="col-xl-8 col-lg-12">
	<form class="woocommerce-cart-form mb-0" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
								...
								<div class="product_container">
									...
									<div class="products">
										...
										if ( ! $product_permalink ) {
											...
											printf( '<a href="%s" class="product_image">%s</a>', esc_url( $product_permalink ), $thumbnail ); // PHPCS: XSS ok.
										}
										?>
										<?php
										if ( ! $product_permalink ) {
											 ...
											 * @since 2.1.0
											 */
											echo wp_kses_post( apply_filters( 'woocommerce_cart_item_name', sprintf( '<a href="%s" class="prod_name">%s</a>', esc_url( $product_permalink ), $_product->get_name() ), $cart_item, $cart_item_key ) );
										}
